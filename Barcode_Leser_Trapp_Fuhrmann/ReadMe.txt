================================================================================
 MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: Barcode_Leser_Trapp_Fuhrmann-Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese Barcode_Leser_Trapp_Fuhrmann-Anwendung für Sie 
...
finden, aus denen Ihre Barcode_Leser_Trapp_Fuhrmann–Anwendung besteht.

Barcode_Leser_Trapp_Fuhrmann.vcxproj
...
Barcode_Leser_Trapp_Fuhrmann.vcxproj.filters
...
Barcode_Leser_Trapp_Fuhrmann.h
    ...
    die CBarcode_Leser_Trapp_FuhrmannApp-Anwendungsklasse.

Barcode_Leser_Trapp_Fuhrmann.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CBarcode_Leser_Trapp_FuhrmannApp-
    Anwendungsklasse enthält.

Barcode_Leser_Trapp_Fuhrmann.rc
...
res\Barcode_Leser_Trapp_Fuhrmann.ico
    Dies ist eine Symboldatei, die als Symbol der Anwendung verwendet wird. 
    Dieses Symbol ist in der Hauptressourcendatei "Barcode_Leser_Trapp_Fuhrmann.rc" 
    enthalten.

res\Barcode_Leser_Trapp_Fuhrmann.rc2
...
Barcode_Leser_Trapp_FuhrmannDlg.h, Barcode_Leser_Trapp_FuhrmannDlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CBarcode_Leser_Trapp_FuhrmannDlg–Klasse. Diese Klasse 
    bestimmt das Verhalten des Hauptdialogfelds Ihrer Anwendung. Die Vorlage des 
    Dialogfelds befindet sich in der Datei "Barcode_Leser_Trapp_Fuhrmann.rc", die in 
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "Barcode_Leser_Trapp_Fuhrmann.pch.pch2 und eine 
